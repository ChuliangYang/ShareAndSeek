...
import kotlinx.android.synthetic.main.activity_free_upload.*
...
class FreeUploadActivity : BaseActivity(),FreeUploadView{
    ...
    @Inject
     lateinit var presenter: FreeUploadPresenter<FreeUploadView>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tb_upload.title = getString(R.string.free)
        configRevealAnim()
    ...
    private fun initPhotoRecyclerview() {
        rv_add.apply {
            layoutManager = GridLayoutManager(this@FreeUploadActivity, 4)
