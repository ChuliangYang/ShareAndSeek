package com.me.cl.capstoneproject.ui.photo;
...
public class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(com.lzy.imagepicker.R.id.recycler);

        findViewById(com.lzy.imagepicker.R.id.btn_back).setOnClickListener(this);
        mBtnOk = findViewById(com.lzy.imagepicker.R.id.btn_ok);
        mBtnOk.setOnClickListener(this);
        mBtnPre = findViewById(com.lzy.imagepicker.R.id.btn_preview);
        ...
        mtvDir = findViewById(com.lzy.imagepicker.R.id.tv_dir);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_PERMISSION_STORAGE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                showToast(getString(R.string.permission_denied_no_album));
            }
        } else if (requestCode == REQUEST_PERMISSION_CAMERA) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                imagePicker.takePicture(this, ImagePicker.REQUEST_CODE_TAKE);
            } else {
                showToast(getString(R.string.permission_denied_no_camera));
            }
        }
    }
