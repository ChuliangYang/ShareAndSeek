...
import static com.lzy.imagepicker.ImagePicker.EXTRA_EXTEND_SHOW_DELETE;
...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra(EXTRA_EXTEND_SHOW_DELETE, true)) {
    ...
    private void showDeleteDialog() {
        ...
        builder.setMessage(getString(R.string.do_you_want_to_delete_photo));
